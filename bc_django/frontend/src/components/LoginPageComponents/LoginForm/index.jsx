        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="form-outline mb-4">
                <input value={email} onChange={(e) => setEmail(e.target.value)}
                       type="email" id="form3Example3cg" className="form-control form-control-lg  bg-dark text-white"/>
                <label className="form-label" htmlFor="form3Example3cg">{emailError ? emailError : 'Your Email'}</label>
            </div>
            ...
            <div className="form-outline mb-4">
                ...
                <label className="form-label" htmlFor="form3Example4cg">{passwordError ? passwordError : 'Your Password'}</label>
            </div>
            ...
            <ErrorDisplay active={emailVerifiedError} setActive={setEmailVerifiedError}>
