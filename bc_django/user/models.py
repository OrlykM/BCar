...
class CustomAccountManager(BaseUserManager):
    def create_user(self, phone,email, username, first_name, password, **other_fields):
        if not email:
    ...
    def create_superuser(self,phone, email, username, first_name, password, **other_fields):
        ...
        return self.create_user(phone ,email, username, first_name, password, **other_fields)

    def create_staff(self,phone, email, username, first_name, password, **other_fields):
        other_fields.setdefault('is_staff', True)
        other_fields.setdefault('is_active', True)
        if other_fields.get('is_staff') is not True:
            raise ValueError('Superuser must be assigned to is_staff=True.')
