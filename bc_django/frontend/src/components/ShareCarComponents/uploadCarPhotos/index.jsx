...
const UploadLicenseForm = () => {
    ...
    return (
        <form>
            <div className="dropzone" {...getRootProps()} style={{marginLeft: "-100px", width: "400px", height:"400px"}}>
                <input {...getInputProps()} />
                <p style={{marginTop:"150px"}}>Drag 'n' drop car photos here, or click to select file</p>
            </div>
            {
                files
