...
urlpatterns = [
    ...
    path('wallet/<int:user_id>/', WalletView.as_view({"put": "put", "get": "get"}), name='wallet_update'),
    path('getId/', GetCurrentUserId.as_view({"get": "get"}, name='get_user_id')),
    path("<int:pk>/upload_lic/", UploadLic.as_view({"put": "put", "get": "get"}),),
    path('getOrder/', GetInfoOrder.as_view({"get": "get"}, name='get_order_id')),
]